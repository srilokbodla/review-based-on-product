...
doc_clean = [clean(doc).split() for doc in example_txt]
#print (doc_clean)
i=0
...
#        print(b.sentiment.polarity)
        ...
        zoom_review.append(b.sentiment.polarity)
avj=0
for j in range(len(zoom_review)):
    avj=avj+zoom_review[j]
if (j==0):
    avj=avj/(j+1)
else:
    avj=avj/j
if(0.5>avj>0):
    print("it is good but not so much effecient")
elif(0.7>avj>=0.5):
    print("it is good to buy")
elif(avj<0):
    print("it is not to buy")
else:
    print("it is execellent")
zarray=zoom_review
if(len(zarray)==1):
    print(zoom_sentenced[0])
else:
    for i in range(len(zarray)):
        if(avj>zarray[i]):
            zarray[i]=avj-zarray[i]
        else:
            zarray[i]=zarray[i]-avj
    s=zarray[0]
    for i in range(len(zarray)):
        if(s>zarray[i]):
            s=zarray[i]
...
#        print(b.sentiment)
        ...
        price_review.append(b.sentiment.polarity)
avj=0
for j in range(len(price_review)):
    avj=avj+price_review[j]
if (j==0):
    avj=avj/(j+1)
else:
    avj=avj/j
if(0.5>avj>0):
    ...
    print("it is not good to buy")
else:
    print("it is execellent")
parray=price_review
for i in range(len(parray)):
    if(avj>parray[i]):
        parray[i]=avj-parray[i]
    else:
        parray[i]=parray[i]-avj
s=parray[0]
for i in range(len(parray)):
    if(s>parray[i]):
        s=parray[i]
...
#        print(b.sentiment)
        ...
        lens_review.append(b.sentiment.polarity)
avj=0
for j in range(len(lens_review)):
    avj=avj+lens_review[j]
if (j==0):
    avj=avj/(j+1)
else:
    avj=avj/j
...
for i in range(len(larray)):
    if(avj>larray[i]):
        larray[i]=avj-larray[i]
    else:
        larray[i]=larray[i]-avj
s=larray[0]
for i in range(len(larray)):
    if(s>larray[i]):
        s=larray[i]
for i in range(len(larray)):
    if(s==larray[i]):
        n=i
print(lens_sentenced[n])
print("\n Sentences related to Picture quality \n")
for j in range(i):
     if "high definition" in sentenced[j] or "picture" in sentenced[j]:
        b=TextBlob(sentenced[j])
#        if b.sentiment.polarity >1:
#        print(sentenced[j])
        picture_sentenced.append(sentenced[j])
        picture_review.append(b.sentiment.polarity)
avj=0
for j in range(len(picture_review)):
    avj=avj+picture_review[j]
if (j==0):
    avj=avj/(j+1)
else:
    avj=avj/j
if(0.5>avj>0):
    ...
    print("ït is not good")
else:
    print("it is execellent")
piarray=picture_review
if(len(picture_review)==0):
    print("picture is okay with this cam")
else:
    for i in range(len(piarray)):
        if(avj>piarray[i]):
            piarray[i]=avj-piarray[i]
        else:
            piarray[i]=piarray[i]-avj
    s=piarray[0]
    for i in range(len(piarray)):
        if(s>piarray[i]):
            s=piarray[i]
...
#        print(b.sentiment)
        ...
        battery_review.append(b.sentiment.polarity)
avj=0
for j in range(len(battery_review)):
    avj=avj+battery_review[j]
if (j==0):
    avj=avj/(j+1)
else:
    avj=avj/j
if(0.5>avj>0):
    ...
    print("it is execellent")
barray=battery_review
if(len(battery_review)==0):
    print("battery life is more when compared to other cameras..")
else:
    for i in range(len(barray)):
        if(avj>barray[i]):
            barray[i]=avj-barray[i]
        else:
            barray[i]=barray[i]-avj
    s=barray[0]
    for i in range(len(barray)):
        if(s>barray[i]):
            s=barray[i]
...
#        print(b.sentiment)
        ...
        shutter_review.append(b.sentiment.polarity)
avj=0
for j in range(len(shutter_review)):
    avj=avj+shutter_review[j]
if (j==0):
    avj=avj/(j+1)
else:
    avj=avj/j
if(0.5>avj>0):
    ...
    print("it is execellent")
sarray=shutter_review
if(len(shutter_review)==0):
    print("speed of this cam is superb")
else:
    for i in range(len(sarray)):
        if(avj>sarray[i]):
            sarray[i]=avj-sarray[i]
        else:
            sarray[i]=sarray[i]-avj
    s1=sarray[0]
    for i in range(len(sarray)):
        if(s1>sarray[i]):
            s1=sarray[i]
...
#           print(b.sentiment)
        ...
        customer_rating.append(b.sentiment.polarity)
avj=0
for j in range(len(customer_rating)):
    avj=avj+customer_rating[j]
if (j==0):
    avj=avj/(j+1)
else:
    avj=avj/j
...
if(len(customer_rating)==0):
    print("it is good in some features .... normal in some")
else:
    carray=customer_rating
    for i in range(len(carray)):
        if(avj>carray[i]):
            carray[i]=avj-carray[i]
        else:
            carray[i]=carray[i]-avj
    print(carray)
    s=carray[0]
    for i in range(len(carray)):
        if(s>carray[i]):
